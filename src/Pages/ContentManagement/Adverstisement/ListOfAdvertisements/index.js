...
const columns = [
  { Header: "#", accessor: "id" },
  { Header: "Advertisement Id", accessor: "advertisementId" },
  { Header: "Event", accessor: "event" },
  { Header: "Short Name", accessor: "shortName" },
  { Header: "Ad Name", accessor: "adName" },
  { Header: "Address", accessor: "address" },
  { Header: "Ad Logo Pat", accessor: "adLogoPat" },
  { Header: "Geo Lat", accessor: "geoLat" },
  { Header: "Geo Long", accessor: "geoLong" },
  { Header: "Ad Descr", accessor: "adDescr" },
  { Header: "Ad City", accessor: "adCity" },
  { Header: "Ad Address", accessor: "adAddress" },
  { Header: "Ad From Date", accessor: "adFromDate" },
  { Header: "Ad to Date", accessor: "adtoDate" },
  { Header: "Ad Web Url", accessor: "adWebUrl" },
  ...
  const exportToExcel = () => {
    const wsData = data.map((item) => ({
     ...
     "Short Name": item.shortName,
      ...
      "Ad Logo Pat": item.adLogoPat,
      "Geo Lat": item.geoLat,
      "Geo Long": item.geoLong,
      "Ad Descr": item.adDescr,
      "Ad City": item.adCity,
      "Ad Address": item.adAddress,
      "Ad From Date": item.adFromDate,
      "Ad to Date": item.adtoDate,
      "Ad Web Url": item.adWebUrl,
...
export default ListOfAdvertisements;

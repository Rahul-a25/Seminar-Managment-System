...
const data = [
  ...
  {
    id: 1,
    eventLocationBannersId: "Speaker",
    eventName: "INR",
    bannerTitle: 45,
    bannerDescr: "true",
...
const columns = [
  { Header: "#", accessor: "id" },
  { Header: "Event Location Banners Id", accessor: "eventLocationBannersId" },
...
const ListOfLocationBanners = () => {
  const [isExpanded, setIsExpanded] = useState(true);

  const exportToExcel = () => {
    const wsData = data.map((item) => ({
      ID: item.id,
      "Event Location Banners Id": item.eventLocationBannersId,
...
export default ListOfLocationBanners;

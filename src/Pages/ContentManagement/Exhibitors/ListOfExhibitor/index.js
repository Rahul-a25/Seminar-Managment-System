...
const data = [
  {
    ...
    meetAt: "true",
    exhibitorCity: "true",
    exhibitorWebsite: "true",
    exhibitorAddress: "true",
    contactPerson: "true",
...
const columns = [
  { Header: "#", accessor: "id" },
  { Header: "Exhibitor Logo", accessor: "exhibitorLogo" },
  { Header: "Exhibitor Name", accessor: "exhibitorName" },
  { Header: "Short Name", accessor: "shortName" },
  { Header: "Exhibitor Description", accessor: "exhibitorDescription" },
  { Header: "Email Id", accessor: "emailId" },
  { Header: "Meet At", accessor: "meetAt" },
  { Header: "Exhibitor City", accessor: "exhibitorCity" },
  { Header: "Exhibitor Website", accessor: "exhibitorWebsite" },
  { Header: "Exhibitor Address", accessor: "exhibitorAddress" },
...
const ListOfExhibitors = () => {
  ...
  const exportToExcel = () => {
    const wsData = data.map((item) => ({
      ID: item.id,
      "Exhibitor Logo": item.exhibitorLogo,
  "Exhibitor Name": item.exhibitorName,
  "Short Name": item.shortName,
  "Exhibitor Description": item.exhibitorDescription,
  "Email Id": item.emailId,
  "Meet At": item.meetAt,
  "Exhibitor City": item.exhibitorCity,
  "Exhibitor Website": item.exhibitorWebsite,
  "Exhibitor Address": item.exhibitorAddress,

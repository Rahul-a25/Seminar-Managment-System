...
const columns = [
  { Header: "#", accessor: "id" },
  { Header: "Event Helpline Id", accessor: "eventHelplineId" },
  { Header: "Event", accessor: "event" },
  { Header: "Helpline Title", accessor: "helplineTitle" },
  { Header: "Helpline No", accessor: "helplineNo" },
...
const ListOfHelplines = () => {
  ...
  const exportToExcel = () => {
    const wsData = data.map((item) => ({
      ID: item.id,
      "Event Helpline Id": item.eventHelplineId,
  "Event": item.event,
   "Helpline Title": item.helplineTitle,
 "Helpline No": item.helplineNo,
  "Geo Lat": item.geoLat,
...
export default ListOfHelplines;
